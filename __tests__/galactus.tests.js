...
describe('GalactusCalculator', () => {
  ...
  test('Should return back the users age if that value is less than the average life expectancy', () => {
    const answer = new GalactusCalculator(1, 50);
    expect(answer.mercuryPassed()).toEqual(4);
  });
  ...
  test('Should return back the users age if that value is less than the average life expectancy', () => {
    const answer = new GalactusCalculator(10, 50);
    expect(answer.marsPassed()).toEqual(5);
  });
  ...
  test('Should calculate jupitarPassed using the average life and users age',() => {
    const answer = new GalactusCalculator(100, 50);
    expect(answer.jupitarPassed()).toEqual(4);
  });

  test('Should return back the users age if that value is less than the average life expectancy', () => {
    const answer = new GalactusCalculator(15, 50);
    expect(answer.jupitarPassed()).toEqual(1);
  });
});
